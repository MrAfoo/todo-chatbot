      ...
      <div className="container mx-auto px-4 py-6 h-[calc(100vh-5rem)] relative z-10">
        <div className="flex gap-4 h-full">
          ...
          <div className="flex-1 bg-terminal-bgLight/80 backdrop-blur-xl rounded-lg shadow-[0_0_20px_rgba(0,255,65,0.2)] flex flex-col border border-neon-cyan/30">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-terminal-bg/50">
              {messages.length === 0 ? (
                ...
                messages.map((msg, idx) => (
                  ...
                  >
                    <div
                      className={`max-w-[85%] rounded border px-5 py-3 font-mono text-sm ${
                        msg.role === "user"
            ...
            >
              {/* Voice Controls Row - Above message box */}
              <div className="flex gap-2 mb-3 justify-end">
                ...
                {isVoiceSupported && (
                  <button
                    ...
                    disabled={loading}
                    className={`px-3 py-2 border rounded transition-all transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed font-mono text-xs font-semibold flex items-center gap-2 ${
                      isListening
                  ...
                  >
                    {isSpeaking ? (
                      ...
                      <>
                        ...
                        <span>{isVoiceEnabled ? 'TTS ON' : 'TTS OFF'}</span>
                      </>
                    )}
                  </button>
                )}
